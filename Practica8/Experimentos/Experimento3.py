''' 
Imprime en la primera línea del display LCD el apellido paterno de algun integrante del equipo y en la segunda la lectura de la temperatura en C°
...
def temp_Celcius():
  with open('/sys/bus/w1/devices/'+ model_temp + "/w1_slave", 'r') as f:
    ...
    tempCelcius = "C: "+ str(int(temp[len(temp)-1])/1000)+ " "
  return tempCelcius
...
def main():
  ...
  while True:
    ...
    lcd_msj_refresh_1s(temp_Celcius(),LCD_2LINE)
